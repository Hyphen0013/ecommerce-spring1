...
public class PaymentController {
	...
	/**
	 * This method for payment by Razorpay
	 * @param orderId
	 * @param jwt
	 * @return
	...
	public ResponseEntity<PaymentLinkResponse> createPaymentLink(
		...
		try {
			...
			// AFTER SUCCESSFULL PAYMENT REDIRECT TO
			paymentLinkRequest.put("callback_url", "http://localhost:3000/payments/"+orderId);
			paymentLinkRequest.put("callback_method", "get");
			
//			PaymentLink payment = razorpay.paymentLink.create(paymentLinkRequest);
			Order payment = razorpay.orders.create(paymentLinkRequest);
			
			// AFTER SUCCESSFULL PAYMENT SEND BACK ID AND URL
